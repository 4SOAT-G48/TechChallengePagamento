...
class MetodoPagamentoControllerTest {
    ...
    void testConsultarMetodoPagamento_Success() throws Exception {
        MetodoPagamento metodoPagamento = new MetodoPagamento(UUID.randomUUID(), "Metodo 1", TipoPagamento.MERCADO_PAGO, "url1");
    ...
    void testGetMetodos() throws Exception {
        ...
        MetodoPagamento response1 = new MetodoPagamento(random1, "nome1", TipoPagamento.MERCADO_PAGO, "url1");
        MetodoPagamento response2 = new MetodoPagamento(random2, "Metodo2", TipoPagamento.MERCADO_PAGO, "url2");
        List<MetodoPagamento> responseList = Arrays.asList(response1, response2);
